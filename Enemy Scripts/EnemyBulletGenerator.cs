...
public class EnemyBulletGenerator : MonoBehaviour
{
    ...
    private void BulletGeneration()
    {
        ...
        if (!offsetHit)
        {
            currentBeatMark = conductor.GetComponent<Conductor>().songPositionInBeats;
        ...
        currentBeatMarkWithOffset = (conductor.GetComponent<Conductor>().songPositionInBeats - initialBeatOffset) % beatsPerBullet;
